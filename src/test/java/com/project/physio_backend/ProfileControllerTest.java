...
public class ProfileControllerTest {
    ...
    void testGetProfileByIdSuccessful() throws Exception {
        ...
        Profile mockProfile = new Profile("Bio", "profilePicUri", 1.75, 70, new Date(), Gender.MALE, Location.BETHLEHEM,
                mockUser);
    ...
    void testUpdateProfileSuccessful() throws Exception {
        ...
        Profile existingProfile = new Profile("Old Bio", "oldPicUri", 1.70, 65, new Date(), Gender.MALE,
                Location.BETHLEHEM, mockUser);
        existingProfile.setProfileID(22L);

        Profile updatedProfile = new Profile("Updated Bio", "newPicUri", 1.75, 70, new Date(), Gender.MALE,
                Location.JERUSALEM, mockUser);
