...
public class ProblemControllerTest {
    ...
    void testGetAllProblems() throws Exception {
        Problem problem1 = new Problem("Problem1", "image1", "Description1");
        Problem problem2 = new Problem("Problem2", "image2", "Description2");
    ...
    void testGetProblemById() throws Exception {
        Problem problem = new Problem("Problem1", "image1", "Description1");
    ...
    void testUpdateProblem() throws Exception {
        Problem existingProblem = new Problem("Problem1", "image1", "Description1");
        existingProblem.setProblemID(1L);

        Problem updatedProblem = new Problem("UpdatedProblem", "updatedImage", "UpdatedDescription");
